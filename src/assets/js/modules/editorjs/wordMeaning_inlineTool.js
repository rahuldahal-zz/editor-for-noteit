export default class WordMeaning {
    ...
    showActions(range) {
        ...
        this.meaningElement.addEventListener("blur", () => this.wrap(range, this.meaningElement.value));
    }
    ...
    checkState(selection) {
        let termWrapper = this.api.selection.findParentTag(this.tag, WordMeaning.CSS);
